...
void Emulator::ExecuteOpcode(BYTE opcode)
{
	...
	case 0x6D: CPU_REG_LOAD(m_RegisterHL.lo, m_RegisterHL.lo, 4); break;
		...
		// write reg to memory
	case 0x70: WriteMemory(m_RegisterHL.reg, m_RegisterBC.hi); m_CyclesThisUpdate += 8; break;
	case 0x71: WriteMemory(m_RegisterHL.reg, m_RegisterBC.lo); m_CyclesThisUpdate += 8; break;
	case 0x72: WriteMemory(m_RegisterHL.reg, m_RegisterDE.hi); m_CyclesThisUpdate += 8; break;
	case 0x73: WriteMemory(m_RegisterHL.reg, m_RegisterDE.lo); m_CyclesThisUpdate += 8; break;
	case 0x74: WriteMemory(m_RegisterHL.reg, m_RegisterHL.hi); m_CyclesThisUpdate += 8; break;
	case 0x75: WriteMemory(m_RegisterHL.reg, m_RegisterHL.lo); m_CyclesThisUpdate += 8; break;
	...
	case 0x02: WriteMemory(m_RegisterBC.reg, m_RegisterAF.hi); m_CyclesThisUpdate += 8; break;
	case 0x12: WriteMemory(m_RegisterDE.reg, m_RegisterAF.hi); m_CyclesThisUpdate += 8; break;
	case 0x77: WriteMemory(m_RegisterHL.reg, m_RegisterAF.hi); m_CyclesThisUpdate += 8; break;
	case 0xE2: WriteMemory((0xFF00 + m_RegisterBC.lo), m_RegisterAF.hi); m_CyclesThisUpdate += 8; break;
	...
	case 0x32: WriteMemory(m_RegisterHL.reg, m_RegisterAF.hi); CPU_16BIT_DEC(m_RegisterHL.reg, 0); m_CyclesThisUpdate += 8; break;
	case 0x22: WriteMemory(m_RegisterHL.reg, m_RegisterAF.hi); CPU_16BIT_INC(m_RegisterHL.reg, 0); m_CyclesThisUpdate += 8; break;
